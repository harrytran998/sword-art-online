...
import type { AutoAttackResult } from "../../application/auto-attack.use-case"
import type {
...
export class CombatPort extends Context.Tag("CombatPort")<
  CombatPort,
  {
    ...
    readonly autoAttack: (
      ...
      dex: number,
      lck: number,
    ) => Effect.Effect<AutoAttackResult, SkillOnCooldownError | InvalidTargetError>
  }
>() {}
